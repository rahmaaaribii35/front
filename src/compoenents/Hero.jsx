    ...
    <div className='flex flex-col sm:flex-row border border-gray-400'>
        ...
        <div className='w-full sm:w-1/2 flex items-center justify-center py-10 px-6 sm:px-12'>
            <div className='text-[#414141] space-y-4'>
                ...
                {/* product name */}
                <h5 className='text-lg sm:text-xl font-semibold uppercase'>
                ...
                {/* description */}
                <h4 className='text-sm sm:text-base text-pink-600 max-w-md leading-relaxed'>
        ...
        {/* Hero right side - cropped video with slightly increased height */}
